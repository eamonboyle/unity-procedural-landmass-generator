...
public class MapGenerator : MonoBehaviour
{
    ...
    private void Awake()
    {
        // Generate the falloff map, ready for use
    ...
    private MapData GenerateMapData(Vector2 centre)
    {
        ...
        for (int y = 0; y < mapChunkSize; y++)
        {
            ...
            {
                // When using falloff map, clamp the coordinates and subtract the falloff map value
                if (useFalloff)
                {
    ...
    private void OnValidate()
    {
        ...
        // Use this to generate the falloff map in the editor.
        falloffMap = FalloffGenerator.GenerateFalloffMap(mapChunkSize);
    }
